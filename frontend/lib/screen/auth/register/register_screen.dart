  ...
  Future<void> signUpUser(
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        print('User created successfully: ${responseData['data']['name']}');
        ...
        if (responseData['message'] == 'Email already exist') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text('Gagal membuat akun: ${responseData['message']}'),
          ));
        }
      } else {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Gagal membuat akun: ${response.body}'),
        ));
      }
    } catch (e) {
        ...
        child: Column(
          children: [
            ...
            TextFormField(
              ...
              focusNode: _emailFocus, // Fokus untuk input Email
              decoration: const InputDecoration(
